<x-dashboard>
 <div class="w-100 formAddUSer mx-auto bg-white p-6 rounded-lg shadow-md">
    ...
    <h2 class="text-2xl text-center text-blue-400 font-bold mb-4">Update User</h2>
    <form method="POST" action="{{route('update',$employee)}}" class="space-y-4">
            @csrf
            @method('PUT')
        <div>
            ...
            name="nameUser"
                ...
                value="{{old('nameUser',$employee->nameUser)}}"
            />
            @error('nameUser')
        ...
        <div>
            ...
            <input 
                ...
                class="w-full mt-1 p-2 border rounded-md"
                value="{{old('emailUser',$employee->emailUser)}}"
            />
            @error('nameUser')
                    <p class="text-red-800 font-bold">name user is required !</p>
            @enderror
        ...
        <div>
            ...
            <div class="flex items-center">
                <input
                    ...
                    class="w-full mt-1 p-2 border rounded-md"
                    maxlength="10"
                    value="{{old('phoneUser',$employee->phoneUser)}}"
                />
        ...
        <div>
            ...
            >{{old('serviceUser',$employee->serviceUser)}}</textarea>
            @error('serviceUser')
